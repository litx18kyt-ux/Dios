...
const FULL_123_MSL_DOCTORS: MslDoctor[] = [
  ...
  { srNo: 74, doctorName: 'ANURAG JAIN', activityType: '', speciality: 'DNB NEFRO', dob: '12/03/1979', doa: '', apr: 'na', may: '', jun: '20', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 113, doctorName: 'BIPIN CHANDRA ADITYA DASARI', activityType: '', speciality: 'CARDIO', dob: '13/05/1990', doa: '', apr: '8,16', may: 'ntc,', jun: '', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 108, doctorName: 'DEEPA KATARA', activityType: '', speciality: 'MD PHYSICAN', dob: '', doa: '', apr: '8,16', may: 'na,25', jun: 'na,26', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  { srNo: 32, doctorName: 'DEEPAK AAMETHA', activityType: 'WCFYH VAL/VIN', speciality: 'MD.CARDIO', dob: '17/03/1980', doa: '', apr: '7,10,17', may: '12,19,26', jun: '16,19,ntc', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 103, doctorName: 'GYANKUMAR DAKSH', activityType: '', speciality: 'General Practitioner (GP)', dob: '', doa: '', apr: '11', may: '', jun: '', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 92, doctorName: 'Harish charpota', activityType: '', speciality: 'M B B S PHY', dob: '16/10/1900', doa: '27/04/1900', apr: 'na', may: '13', jun: '17,26', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 21, doctorName: 'HEMANT MAHUR', activityType: 'CRM', speciality: 'MD MED', dob: '25/03/1996', doa: '', apr: 'out of Town ', may: '', jun: '', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 42, doctorName: 'JAY CHORDIYA', activityType: 'LGT TABLE TOP', speciality: 'DM ENDO', dob: '21/04/2019', doa: '', apr: 'appointment ', may: '', jun: '', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 44, doctorName: 'JITESH AGRAWAL', activityType: 'VTL TABLE TOP', speciality: 'MBBB MD', dob: '', doa: '', apr: 'appointment ', may: '29', jun: '', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 35, doctorName: 'KAPIL BHARGAV', activityType: 'WCFYH VAL/VIN', speciality: 'DM CARDIO', dob: '16/12/2019', doa: '', apr: '3,17,24', may: 'ntc', jun: '19', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 47, doctorName: 'KC JAIN', activityType: '', speciality: 'MD MED', dob: '24/07/2019', doa: '', apr: '2 times not available ,18', may: '', jun: '', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  { srNo: 19, doctorName: 'KIRIT GANDHI', activityType: 'CRM', speciality: 'MD MED', dob: '11/07/2019', doa: '', apr: '8,16', may: 'na ,25', jun: '17,26', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 82, doctorName: 'LALIT JAINANI', activityType: '', speciality: 'MD MED', dob: '11/04/2019', doa: '', apr: '', may: '11', jun: '', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 83, doctorName: 'MADHUP BAXI', activityType: '', speciality: 'MD MED', dob: '29/01/2019', doa: '', apr: '', may: '11', jun: '', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 30, doctorName: 'Mona dingra', activityType: 'WCFYH VTL', speciality: 'ENDO', dob: '18/07/1900', doa: '10/02/1900', apr: 'out of Town ,18,23', may: '21,28', jun: '22', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 4, doctorName: 'NAVGEET MATHUR', activityType: 'CRM', speciality: 'MD MED', dob: '', doa: '', apr: '3,11', may: 'na out of town', jun: 'na,13,19', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 46, doctorName: 'Nilesh pathira', activityType: 'GLUCOMETER', speciality: 'M B B S PHY', dob: '28/01/1900', doa: '14/04/1900', apr: 'appointment ,28', may: '12,19,26', jun: '2,ntc', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 110, doctorName: 'Praveen jain', activityType: '', speciality: 'MBBS', dob: '', doa: '', apr: '', may: '10', jun: '', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 104, doctorName: 'RAMKUMAR DAKSH', activityType: '', speciality: 'GP', dob: '', doa: '', apr: '', may: '11', jun: '', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 55, doctorName: 'RK SHARMA', activityType: '', speciality: 'DM ENDO', dob: '14/01/2019', doa: '', apr: 'na,14,21,28', may: '6,12,19,26', jun: '9,16', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 39, doctorName: 'S K KUASHIK', activityType: 'A2 GHEE', speciality: 'DM CARDIO', dob: '', doa: '', apr: '2,17,27', may: '6,27', jun: 'na,13,24', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  { srNo: 118, doctorName: 'S.A.BOHRA', activityType: '', speciality: 'MBBS MD', dob: '', doa: '', apr: 'na,21,28', may: '12,19,26', jun: '2,9,16', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 101, doctorName: 'SANDEEP CHANDOLIYA', activityType: '', speciality: 'MBBB MD', dob: '', doa: '', apr: '', may: '11', jun: '', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 36, doctorName: 'Sanjay Gandhi', activityType: 'WCFYH VAL/VIN', speciality: 'C V T S', dob: '', doa: '', apr: '', may: '13', jun: '', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 84, doctorName: 'SHUSHIL CHOUHAN', activityType: '', speciality: 'MD MED', dob: '17/02/2019', doa: '', apr: '', may: '4,23', jun: '', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  { srNo: 15, doctorName: 'SUMIT SIROIYA', activityType: 'CRM', speciality: 'MD MED', dob: '14/01/2019', doa: '', apr: 'na,18', may: '', jun: '12', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 94, doctorName: 'SURAJ GUPTA', activityType: '', speciality: 'NEPHROLOGIST', dob: '', doa: '', apr: '3,na', may: '8,15', jun: '13,19', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  { srNo: 26, doctorName: 'Suresh Chandra', activityType: 'CRM', speciality: 'GEN MED', dob: '', doa: '', apr: 'na', may: '', jun: '', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 52, doctorName: 'TARUN RHLOT', activityType: '', speciality: 'DM NEURO', dob: '', doa: '', apr: 'appointment', may: '', jun: '', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  { srNo: 31, doctorName: 'UDAY BHOMIK', activityType: 'WCFYH VTL', speciality: 'DM NEURO', dob: '08/04/2019', doa: '', apr: 'na,30', may: '15', jun: '12', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
  ...
  { srNo: 63, doctorName: 'YN VERMA', activityType: '', speciality: 'MD MED', dob: '03/07/2019', doa: '', apr: '', may: '11', jun: '22', jul: '', aug: '', sept: '', oct: '', nov: '', dec: '', jan: '', feb: '', mar: '' },
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-800">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Complete Master List of all 123+ Doctors — Fully Editable</p>
          </div>
        </div>
        ...
        <table className="w-full text-left text-xs border-collapse">
          <thead className="sticky top-0 bg-slate-950 text-slate-400 font-bold uppercase border-b border-slate-800 z-10">
            <tr>
              ...
              <th className="p-2.5 text-center w-20 text-cyan-300">OCT</th>
              <th className="p-2.5 text-center w-20 text-emerald-300">NOV</th>
              <th className="p-2.5 text-center w-20 text-purple-300">DEC</th>
              <th className="p-2.5 text-center w-20 text-blue-300">JAN</th>
              <th className="p-2.5 text-center w-20 text-amber-300">FEB</th>
              <th className="p-2.5 text-center w-20 text-rose-300">MAR</th>
                ...
                {['apr', 'may', 'jun', 'jul', 'aug', 'sept', 'oct', 'nov', 'dec', 'jan', 'feb', 'mar'].map(monthKey => (
                  <td key={monthKey} className="p-1">
                    <input
                      ...
                      placeholder="-"
                      className="w-full py-1.5 px-1 bg-slate-950 rounded-lg font-mono text-slate-200 border border-slate-800 focus:border-cyan-500 focus:outline-none text-center text-xs"
                    />
                  </td>
                ))}
