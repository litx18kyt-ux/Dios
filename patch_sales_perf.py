...
# 3. Update handleCellChange to persist in memoryStore
...
# 4. Add handleAutoSyncFromDataHub function before calculateCell
...
# 5. Add Auto-Sync button in UI before Upload SPO Excel
...
with open(path, 'w') as f:
    f.write(content)
print("✅ SalesPerformanceSheet.tsx patched successfully!")
