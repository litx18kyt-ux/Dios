...
async function onRequest2(context2) {
  ...
  try {
    const body = await context2.request.json();
    const apiRes = await fetch("https://organic-parakeet-gx7rv659gjp5f97qv-8000.app.github.dev/api/fetch-cbo-excel", {
      method: "POST",
...
// api/fetch-sales-performance.ts
async function onRequest6(context2) {
  ...
  try {
    const body = await context2.request.json();
    const apiRes = await fetch("https://organic-parakeet-gx7rv659gjp5f97qv-8000.app.github.dev/api/fetch-sales-performance", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(body)
    });
    ...
    return new Response(JSON.stringify({
      ...
      sales_return_breakdown: [
        { id: "sr_1", partyName: "NAGDA DISTRIBUTORS", amount: 3200, note: "Leakage breakage return" },
        { id: "sr_2", partyName: "MODI DISTRIBUTORS", amount: 2390, note: "Damaged goods in transit" }
      ],
      expiry_breakdown: [
        { id: "ex_1", partyName: "NAGDA DISTRIBUTORS", amount: 12500, note: "Linaget / Valros near expiry batch" },
        { id: "ex_2", partyName: "SHREE VARDHMAN PHARMA", amount: 5498, note: "Vintel Expired stock" },
        { id: "ex_3", partyName: "DWARIKA MEDICALS", amount: 3500, note: "Vidmet liquidation remaining" }
      ]
    }), {
      status: 200,
      headers: { "Content-Type": "application/json", "Access-Control-Allow-Origin": "*" }
...
// ../.wrangler/tmp/pages-k1Bvlj/functionsRoutes-0.10806648326093127.mjs
var routes = [
  {
