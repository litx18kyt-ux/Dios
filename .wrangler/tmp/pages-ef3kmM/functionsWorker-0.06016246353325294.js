...
async function onRequest6(context2) {
  ...
  try {
    ...
    const targetMonth = body.from_month || "Aug-2026";
    return new Response(JSON.stringify({
      success: true,
      month: targetMonth,
      net_sales: 432271,
      ...
      sales_return_breakdown: [
        { id: "sr_1", partyName: "NAGDA DISTRIBUTORS", amount: 3200, note: `${targetMonth} Batch replacement return` },
        { id: "sr_2", partyName: "MODI DISTRIBUTORS", amount: 2390, note: `${targetMonth} Goods transit damage` }
      ],
      expiry_breakdown: [
        { id: "ex_1", partyName: "NAGDA DISTRIBUTORS", amount: 12500, note: `${targetMonth} Linaget/Valros expiry batch` },
        { id: "ex_2", partyName: "SHREE VARDHMAN PHARMA", amount: 5498, note: `${targetMonth} Vintel Expired carton` },
        { id: "ex_3", partyName: "DWARIKA MEDICALS", amount: 3500, note: `${targetMonth} Remaining unsold expiry` }
      ]
    }), {
      status: 200,
      headers: {
...
// ../.wrangler/tmp/pages-ef3kmM/functionsRoutes-0.4278385956236922.mjs
var routes = [
  {
