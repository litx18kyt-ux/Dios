...
sheet_code = '''import React, { useState, useRef } from 'react';
import { 
...
export const SalesPerformanceSheet: React.FC = () => {
  ...
  // Persist formData in memoryStore so data never disappears across tab/module switches
  ...
  // Auto-Sync Secondary 26-27 & Closing Stock from Data Hub (Un. Sales Progression)
...
with open('src/components/review/SalesPerformanceSheet.tsx', 'w') as f:
    f.write(sheet_code)
print('✅ SalesPerformanceSheet.tsx updated with memory persistence & Data Hub auto-sync!')
